...
(defun my/citar-open-noter (key)
  "Open roam note for KEY and start org-noter in a dedicated frame."
  (interactive (list (citar-select-ref)))
  (select-frame (make-frame))
  (citar-open-notes (list key))
  (org-noter))

(map! :leader :desc "Open noter session" "n N" #'my/citar-open-noter)
