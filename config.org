...
#+begin_src shell :tangle "./dot_claude/skills/tangle-moi/ensure-dirs.sh" :shebang "#!/bin/sh"
...
#+begin_src shell :tangle "./dot_claude/skills/tangle-moi/tangle.sh" :shebang "#!/bin/sh"
