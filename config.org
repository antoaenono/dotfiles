...
Chezmoi places files relative to the =$HOME= directory.
...
*** Shell (zsh)
**** Configuration Files
These are documented below in the in order that they are loaded.
...
Symlink:
#+begin_src fundamental :tangle "./symlink_dot_zshenv"
/Users/antoaenono/.config/zsh/.zshenv
#+end_src
...
**** oh-my-zsh
#+begin_src shell :tangle "./.chezmoiscripts/darwin/run_once_before_03-bootstrap-shell.sh" :shebang "#!/bin/bash"
set -e
...
**** Doom
***** Download (Install)
#+begin_src shell :tangle "./.chezmoiscripts/darwin/run_once_before_02-bootstrap-doom.sh" :shebang "#!/bin/bash"
set -e
...
***** TODO Add ~doom~ command to =PATH= (in =.zshrc=)
#+begin_src shell
